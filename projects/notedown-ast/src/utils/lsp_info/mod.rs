pub use lsp_types::{Position, Range, Url};
...
impl Default for LSPMetaInfo {
    fn default() -> Self {
        Self { range: Default::default(), url: None }
    }
}
...
impl LSPMetaInfo {
    pub fn set_range(&mut self, x1: u32, y1: u32, x2: u32, y2: u32) {
        self.range = Range { start: Position { line: x1, character: y1 }, end: Position { line: x2, character: y2 } }
    }
